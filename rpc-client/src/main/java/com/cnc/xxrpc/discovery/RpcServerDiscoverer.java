...
public class RpcServerDiscoverer {
    ...
    private static final Map<String, Set<? extends Channel>> SERVER_CHANNEL_MAP = new ConcurrentHashMap<>();
    ...
    public static Channel getServerChannel(Class<?> clz) throws Exception {
        ...
        return client.getBootstrap().connect("127.0.0.1",8099).sync().channel();
